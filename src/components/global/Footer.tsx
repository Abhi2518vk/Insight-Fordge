      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="border-t border-border-custom/40 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="https://www.linkedin.com/in/insightforgesite" target="_blank" rel="noopener noreferrer" className="p-3 min-w-[44px] min-h-[44px] rounded-lg bg-bg-surface hover:bg-brand-primary/10 hover:text-brand-primary transition-all duration-200 flex items-center justify-center text-text-secondary" aria-label="LinkedIn">
